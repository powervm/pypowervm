...
class LPARBuilder(object):
    ...
    def build_mem(self):
        ...
        # The PPT ratio should be passed into attrs as a string in ratio
        # format. The logarithm is calculated from the ratio here because
        # this is how REST consumes the value.
