...
class LPARWrapperValidator(object):
    ...
    """
    def __init__(self, lpar_w, sys_w, curr_lpar_w=None):
        """Initialize the validator

        :param lpar_w: LPAR wrapper intended to be validated
        :param sys_w: managed_system wrapper intended to be validated
    ...
    def validate_all(self):
        ...
        ProcValidator(self.lpar_w, self.sys_w, self.curr_lpar_w).validate()
...
class ProcValidator(BaseValidator):
    ...
    def _validate_deploy(self):
        ...
        """
        procs_avail = self.sys_w.proc_units_avail
