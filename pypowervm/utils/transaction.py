...
def entry_transaction(func):
    ...
    The consumer of the decorated method may pass either an EntryWrapper or an
    EntryWrapperGetter as the first argument.  The developer of the decorated
    method is guaranteed that the first argument is an EntryWrapper.
