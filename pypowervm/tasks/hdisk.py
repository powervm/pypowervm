...
# TODO(efried): Remove this once VIOS supports pg83 descriptor in Events
# >>>CUT HERE>>>
def get_pg83_via_job(adapter, vios_uuid, udid):
    ...
    lua_xml = ('<VIO version="1.21"><Request action_str="QUERY_INVENTORY">'
               '<InventoryRequest inventoryType="base">'
               '<VioTypeFilter type="PV"/><VioUdidFilter udid="%s"/>'
               '</InventoryRequest></uom:Request></VIO>' % udid)
