...
def find_trunks(adapter, cna_w):
    ...
    host_wraps = get_all_lpars(adapter, mgmt_partition=True)
...
def get_all_lpars(adapter, mgmt_partition=None):
    """Returns all lpars.

    :param adapter: The pypowervm adapter to perform the search with.
    :param mgmt_partition: This is optional. If specified, will search for
                           mgmt_partitions only.
