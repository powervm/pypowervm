...
def remove_vopt_mapping(adapter, vios_uuid, media_name, client_lpar_id):
    ...
    Will leave other elements on the vSCSI bus in tact.
    ...
    def search_func(existing_elem):
        ...
        if existing_elem.media_name == media_name:
...
def remove_vdisk_mapping(adapter, vios_uuid, disk_name, client_lpar_id):
    ...
    elements on the vSCSI bus in tact.
    ...
    def search_func(existing_elem):
        ...
        if existing_elem.name == disk_name:
            return existing_elem
        else:
            return None
