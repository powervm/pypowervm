...
def set_vnic_back_devs(vnic_w, pports, sys_w=None, vioses=None, redundancy=1,
    ...
    _pports_config(pports)
    if redundant_pports and redundancy > 1:
        _pports_config(redundant_pports, vio_idx=1)
