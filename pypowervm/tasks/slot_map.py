...
class SlotMapStore(object):
    ...
    def register_vfc_mapping(self, vfcmap, fab):
        ...
        """
        vfc_client_wwpn = vfcmap.client_adapter.wwpns
        wwpn_map = {vfcmap.server_adapter.lpar_slot_num: vfcmap.client_adapter.wwpns}
        self._reg_slot(IOCLASS.VFC, fab, vfcmap.server_adapter.lpar_slot_num, extra_spec=wwpn_map)
