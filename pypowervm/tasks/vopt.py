...
def validate_vopt_repo_exists(
    ...
    # Did not find the vopt.  Need a deeper query
    return _find_or_rebuild_vopt(adapter, vopt_media_volume_group,
                                 vopt_media_rep_size)


def _find_or_rebuild_vopt(adapter, vopt_media_volume_group,
                          vopt_media_rep_size):
    ...
    vio_wraps = partition.get_active_vioses(adapter)
