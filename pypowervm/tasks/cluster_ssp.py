...
def _upload_conflict(lus, luname, mkr_luname):
    """Detect an upload conflict where our thread should abdicate.
    ...
    while True:
        ...
        try:
            ...
            try:
                ...
                # If another process got through all of the above at the same
                # time as this one, and it hits crt_lu first, our crt_lu will
                # 412, reload the SSP, and redrive.  At that point, it will
