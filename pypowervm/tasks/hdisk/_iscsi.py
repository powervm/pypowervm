...
def discover_iscsi(adapter, host_ip, user, password, iqn, vios_uuid,
    ...
    if multipath:
        _add_parameter(job_parms, job_wrapper, 'discoveryAuth', discovery_auth)
        _add_parameter(job_parms, job_wrapper, 'discoveryUser',
                       discovery_username)
        _add_parameter(job_parms, job_wrapper, 'discoveryPassword',
                       discovery_password)
