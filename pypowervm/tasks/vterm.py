...
class _VNCRepeaterServer(threading.Thread):
    ...
    def _enable_x509_authentication(self, client_socket, server_socket):
        ...
        """
        try:
            # First do the Security Handshake to make sure it is supported
            if self._perform_security_handshake(client_socket, server_socket):
    ...
    def _perform_security_handshake(self, client_socket, server_socket):
        """Performs the Handshakes VeNCrypt using X509 Authentication.
