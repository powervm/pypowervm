...
def open_localhost_vnc_vterm(adapter, lpar_uuid, force=False):
    ...
    # The only error message that is fine is a return code of 3 saying that a
    # session is already started, where they gave us the port back meaning that
    # it was started as VNC.  Else, throw an exception with the error message.
