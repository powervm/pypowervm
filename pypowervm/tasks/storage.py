...
def upload_new_lu(v_uuid,  ssp, d_stream, lu_name, f_size, d_size=None,
    ...
    maybe_file = upload_lu(v_uuid, ssp, new_lu, d_stream, f_size,
                           sha_chksum=sha_chksum)
    return new_lu, maybe_file


def upload_lu(v_uuid, ssp, lu, d_stream, f_size, sha_chksum=None):
    ...
    vio_file = _create_file(
        ssp.adapter, lu.name, file_type, v_uuid, f_size=f_size,
