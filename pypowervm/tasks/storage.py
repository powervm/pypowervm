...
def upload_lu(v_uuid, lu, io_handle, f_size, sha_chksum=None,
    ...
    file_type = (vf.FileType.DISK_IMAGE_COORDINATED
                 if lu.traits.local_api else vf.FileType.DISK_IMAGE)
...
def _copy_func(vio_file, io_handle, upload_type):
    ...
    try:
        ...
        # this runs in separate threads.  If the other thread has an
        # exception this may just be hidden.  Force a log, even though it
        # may be redundant.
        LOG.exception(e)
        raise
