...
_SUFFIX_PARM_REQUEST_CONTROLLER = 'RequestMaster'
_SUFFIX_PARM_RELEASE_CONTROLLER = 'ReleaseMaster'

CO_MGMT_CONTROLLER_STATUS = "coManagementMasterStatus"
...
@lgc.logcall
def request_controller(msys, mode=ControllerMode.NORMAL,
