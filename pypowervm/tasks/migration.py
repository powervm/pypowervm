...
def migrate_lpar(lpar, tgt_mgd_sys, validate_only=False,
                 ...
                 vlan_mappings=None, dest_msp_name=None, source_msp_name=None,
    ...
    The first '/' must be present.  The first is the mac address of the adapter
    and the second is what the target PVID should be set to for that adapter.
    The remaining is a list of additional VLANs that could be specified for
    adapters that have additional VLANs.  If not specified, then no additional
    VLANs will be on the target adapter.
