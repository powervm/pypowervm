...
def migrate_lpar(
        ...
        check_affinity_score_on_dest=None):
    ...
    :param check_affinity_score_on_dest: (Optional) The enforce_affinity_check
                                         metadata value of the VM. If enabled
                                         and set to true, will pass the
                                         'Affinity' flag as part of migration
                                         job.
    ...
    if check_affinity_score_on_dest is not None:
        job_parms.append(
            job_wrapper.create_job_parameter(AFFINITY,
                                             check_affinity_score_on_dest))
