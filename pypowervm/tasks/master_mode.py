...
class MasterMode(object):
    ...
    NORMAL: Default mode
    TEMP:   HMC flag used to only temporarily receive master mode.
    """
    NORMAL = "norm"
    TEMP = "temp"
...
def request_master(msys, mode=MasterMode.NORMAL,
    ...
    :param mode: The requested master mode type. There are 2 options:
                 "norm" and "temp". "norm" is default, and "temp" is available
                 to HMCs to temporarily request master mode.
