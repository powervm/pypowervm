...
class LparStorage(object):
    ...
    def __init__(self, lpar_phyp_storage, vios_metrics):
        ...
        for vadpt in lpar_phyp_storage.v_stor_adpts:
            vio_adpt = LparStorage._find_vio_vstor_adpt(vadpt, vios_metrics)
        ...
        for phyp_vfc_adpt in lpar_phyp_storage.v_fc_adpts:
            vfc_adpt = LparStorage._find_vio_vfc_adpt(phyp_vfc_adpt,
                                                      vios_metrics)
...
class LparStorageAdpt(object):
    ...
    The supported metrics are as follows:
      ...
      - physical_location: The physical location of the adapter.
    ...
    _supported_metrics = ('name', 'physical_location', 'num_reads',
...
class LparPhysAdpt(LparStorageAdpt):
    ...
    """
    _supported_metrics = ('name', 'physical_location', 'num_reads',
                          'num_writes', 'read_bytes', 'write_bytes', 'type')
...
class LparNetwork(object):
    ...
    def __init__(self, lpar_sample_net):
        ...
        self.cnas = (None if lpar_sample_net.veas is None else
