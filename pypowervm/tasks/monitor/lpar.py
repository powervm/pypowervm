...
class LparProc(PropertyWrapper):
    ...
    def __init__(self, lpar_processor):
        ...
        """
        super(LparProc, self).__init__(lpar_processor)
...
class LparStorageAdpt(PropertyWrapper):
    ...
    def __init__(self, adpt):
        ...
        :param adpt: The raw metric adapter as defined by the subclass type.
        """
        super(LparStorageAdpt, self).__init__(adpt)
...
class LparCNA(PropertyWrapper):
    ...
    def __init__(self, vea):
        ...
        """
        super(LparCNA, self).__init__(vea)
