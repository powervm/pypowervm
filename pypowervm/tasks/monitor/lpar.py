...
class LparMemory(object):
    ...
    The supported metrics are as follows:
      ...
      - pct_real_mem_avbl: Percentage of available memory on VMs. It is
                           ...
                           in use.
      - total_pg_sp_size_count: Page count of swap space for this VM. Page
                                count size is 4k pages.
      - total_pg_sp_free_count: Page count of free swap space for this VM.
                                Page count size is 4k pages.
      - vm_active_pg_count: Page count of total active memory for this VM.
                            Page count size is 4k pages.
