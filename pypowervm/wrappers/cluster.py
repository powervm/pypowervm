...
@ewrap.ElementWrapper.pvm_type('Node', has_metadata=True, child_order=(
    _N_HOSTNAME, _N_LPARID, _N_NAME, _N_MTMS, _N_VIOS_LEVEL, _N_VIOS_LINK,
    _N_IPADDR
))
class Node(ewrap.ElementWrapper):
    ...
    def _mtms(self, new_mtms):
        ...
        self.element.inject(new_mtms.element, self.child_order)
