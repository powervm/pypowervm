...
_PV_EL_ORDER = [_PV_READ_IOPS, _PV_WRITE_IOPS, _PV_ENCRYPTION_STATE,
                _PV_ENCRYPTION_KEY, _PV_ENCRYPTION_AGENT, _PV_VOL_ID,
...
class PV(ewrap.ElementWrapper, _StorageQoS, _StorageEncryption):
    ...
    @classmethod
    def bld(cls, adapter, name, udid=None, device_tag=None):
        ...
        :param device_tag: Identifier with which to tag the physical device
                           upon mapping.
    ...
    def _set_volume_id(self, volume_id):
        self.set_parm_value(_PV_VOL_ID, volume_id, attrib=c.ATTR_KSV190)
