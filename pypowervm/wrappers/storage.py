...
class PV(ewrap.ElementWrapper):
    ...
    def pg83(self):
        ...
        if not hasattr(self, 'parent'):
            # Raise the exception.  Once the VIOS supports the events, this
            # should not require the parent attribute and therefore even
            # VSCSIMappings should have the attribute.
