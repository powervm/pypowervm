...
class Network(object):
    ...
    def __init__(self, net):
        ...
        self.seas = [SharedEthernetAdapter(x)
...
class SharedEthernetAdapter(NetworkAdpt):
    """Represents a Shared Ethernet Adapter on the VIOS."""

    def __init__(self, bridge):
        super(SharedEthernetAdapter, self).__init__(bridge)
...
class Storage(object):
    ...
    def __init__(self, storage):
        ...
        self.fc_adpts = [PhysFCAdpt(x) for x in fc_adpts]
...
class PhysFCAdpt(StorageAdpt):
    """Represents a physical fiber channel adapter on the VIOS."""

    def __init__(self, adpt):
        super(PhysFCAdpt, self).__init__(adpt)
        ...
        self.ports = [VirtFCAdpt(x) for x in vadpts]


class VirtFCAdpt(StorageAdpt):
    """Represents a Virtual FC Port (NPIV)."""

    def __init__(self, vadpt):
        super(VirtFCAdpt, self).__init__(vadpt)
