...
class LparInfo(object):
    ...
    def _create_lpar_memory_util_for_errored_vm(
        ...
        lpar_metrics_rsct.update(dict(memory=memory))
...
class LparMemory(object):
    ...
    def __init__(self, memory):
        self._pct_real_mem_free = memory.get('pctRealMemFree', None)
        self._vm_pg_in_rate = memory.get('vmPgInRate', None)
        self._vm_pg_out_rate = memory.get('vmPgOutRate', None)
        self._vm_pg_swap_in_rate = memory.get('vmPgSpInRate', None)
        self._vm_pg_swap_out_rate = memory.get('vmPgSpOutRate', None)
