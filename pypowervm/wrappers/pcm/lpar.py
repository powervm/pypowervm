...
class LparInfo(object):  # pylint: disable=too-few-public-methods   
...
class LparUtil(object):  # pylint: disable=too-few-public-methods   
...
class LparMemory(object):  # pylint: disable=too-few-public-methods   
