...
class IOSlot(ewrap.ElementWrapper):
    ...
    """
    @classmethod
    def bld(cls, adapter, required, bus_grp_required, drc_name,
            description=''):
    ...
    class AssociatedIOSlot(ewrap.ElementWrapper):
        ...
        """
        @classmethod
        def _bld_new(cls, adapter, bus_grp_required, drc_name, description):
            ...
            io_adp = IOAdapter._bld_new(adapter, drc_name, description)
    ...
    def required(self, val):
        self.set_parm_value(_IO_SLOT_REQ, val)
...
class IOAdapter(ewrap.ElementWrapper):
    ...
    """
    @classmethod
    def _bld_new(cls, adapter, drc_name, description=''):
