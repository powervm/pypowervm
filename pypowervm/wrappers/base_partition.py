...
_MEM_PPT_RATIO = 'PhysicalPageTableRatio'
...
_MEM_CURR_PPT_RATIO = 'CurrentPhysicalPageTableRatio'
...
class LPARCompat(object):
    ...
    POWER7 = 'POWER7'
    POWER8 = 'POWER8'
    POWER8_ENHANCED = 'POWER8_Enhanced'
...
class BasePartition(ewrap.EntryWrapper, _DlparCapable):
    ...
    def current_secure_boot(self):
        ...
        and their interpretations:
          ...
          * 01: Secure boot enabled (log only)
          * 02: Secure boot enabled and enforced
          * 03-09: Secure boot enabled and enforced. Firmware or OS may
...
class PartitionMemoryConfiguration(ewrap.ElementWrapper):
    ...
    @property
    def ppt_ratio(self):
        """The Physical Page Table Ratio

        The physical page table ratio represents the ratio of a VM's maximum
        memory to the size of its physical page table. The PPT is used by the
    ...
    def ppt_ratio(self, ppt_ratio):
        ...
        :param ppt_ratio: The ppt ratio value.
        """
