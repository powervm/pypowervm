...
class IOSlot(ewrap.ElementWrapper):
    ...
    def bld(cls, adapter, bus_grp_required, description, feat_codes,
        ...
        assoc_io_slot = cls.AssociatedIOSlot._bld(adapter, bus_grp_required,
                                                  description, feat_codes,
                                                  pci_class, pci_sub_dev_id,
                                                  pci_rev_id, pci_vendor_id,
                                                  pci_sub_vendor_id,
                                                  drc_index, drc_name)
    ...
    class AssociatedIOSlot(ewrap.ElementWrapper):
        ...
        """
        @classmethod
        def _bld(cls, adapter, bus_grp_required, description, feat_codes,
                 pci_class, pci_sub_dev_id, pci_rev_id, pci_vendor_id,
                 pci_sub_vendor_id, drc_index, drc_name):
            """Build a new AssociatedIOSlot wrapper.

            This will not typically be called outside of the IOSlot._bld
            class method.
            ...
            io_adp = IOAdapter._bld(adapter, drc_index, drc_name, description)
...
class IOAdapter(ewrap.ElementWrapper):
    ...
    """
    @classmethod
    def _bld(cls, adapter, drc_index, drc_name, description=''):
        """Build a new IOAdapter wrapper with all required parameters.

        These arguments are based around the parameters needed to build
        a an IOAdapter element. Generally, these will be pulled from the
        ...
        new_adp._phys_loc_code(drc_index)
