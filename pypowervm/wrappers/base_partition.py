...
class PartitionMemoryConfiguration(ewrap.ElementWrapper):
    ...
    @property
    def exp_factor(self):
        # Setting this to 0 will turn/keep AME off. The valid values
        # are 1.0 <= x <= 10.0 up to 2 decimal places. The expansion
        # factor represents the target memory multiplier. e.g. An
        # LPAR with EF = 2 which has 4 GB of memory will have a target
