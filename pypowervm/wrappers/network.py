...
class NetBridge(ewrap.EntryWrapper):
    ...
    def bld(cls, adapter, pvid, vios_to_backing_adpts, vlan_ids, vswitch,
        ...
        :param load_sharing: (Optional) If set to True, the load balancing will
                             enabled across the two SEAs.  This does require
                             multiple backing adapters (two SEAs).
...
class SEA(ewrap.ElementWrapper):
    ...
    def ha_mode(self):
        ...
        """
        # Default to None to indicate that the API will decide.
