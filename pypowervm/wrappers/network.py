...
class CNA(ewrap.EntryWrapper):
    ...
    def bld(cls, adapter, pvid, vswitch_href, slot_num=None, mac_addr=None,
            addl_tagged_vlans=None, trunk_priority=None):
        ...
        :param trunk_priority: Optional TrunkPriority integer that, if
                               specified, will create this wrapper as a trunk.
