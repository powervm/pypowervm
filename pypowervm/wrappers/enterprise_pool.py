...
class Pool(entry_wrapper.EntryWrapper):
    ...
    def compliance_hours_left(self):
        ...
        """
        return self._get_val_int(_P_COMPLIANCE_REMAINING_HOURS)
...
class PoolMember(entry_wrapper.EntryWrapper):
    ...
    def proc_compliance_hours_left(self):
        ...
        ComplianceRemainingHours.
        """
        return self._get_val_int(_PM_PROC_COMPLIANCE_HOURS_LEFT)
    ...
    def mem_compliance_hours_left(self):
        ...
        ComplianceRemainingHours.
        """
        return self._get_val_int(_PM_MEM_COMPLIANCE_HOURS_LEFT)
