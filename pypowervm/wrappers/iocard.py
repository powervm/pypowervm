...
class VNIC(ewrap.EntryWrapper):
    ...
    # Proxy nested @propertys from VNICDetails
    pvid = u.nestedprop(_details, VNICDetails.pvid)
    allowed_vlans = u.nestedprop(_details, VNICDetails.allowed_vlans)
    mac = u.nestedprop(_details, VNICDetails.mac)
    allowed_macs = u.nestedprop(_details, VNICDetails.allowed_macs)
    capacity = u.nestedprop(_details, VNICDetails.capacity)
