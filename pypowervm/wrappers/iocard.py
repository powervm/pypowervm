...
class VNICDetails(ewrap.ElementWrapper):
    ...
    @property
    def mac(self):
        """MAC address of the format xxxxxxxxxxxx (12 lowercase hex digits)."""
...
class VNICBackDev(ewrap.ElementWrapper):
    ...
    def bld(cls, adapter, vios_uuid, sriov_adap_id, pport_id, capacity=None):
        ...
        bdev._vios_href(adapter.build_href('VirtualIOServer', vios_uuid,
                                           xag=[]))
