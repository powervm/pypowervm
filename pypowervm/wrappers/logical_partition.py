...
class PartitionMemoryConfiguration(ewrap.ElementWrapper):
    ...
    def bld(cls, mem, min_mem=None, max_mem=None):
        ...
        :param mem: The amount of memory for the partition in MB (str)
        :param min_mem: The minimum amount of memory in MB (str). Defaults to
            the mem param
        :param max_mem: The maximum amount of memory in MB (str). Defaults to
            the mem param
...
class PartitionProcessorConfiguration(ewrap.ElementWrapper):
    ...
    def bld_shared(cls, proc_unit, proc,
                   sharing_mode=_SHARING_MODES[1], uncapped_weight=128,
                   min_proc_unit=None, max_proc_unit=None,
        ...
        :param sharing_mode: Sharing mode of the processors
        :param uncapped_weight: Uncapped weight of the processors
        ...
        proc_cfg.has_dedicated_proc = False
    ...
    def bld_dedicated(cls, proc, min_proc=None, max_proc=None,
                      sharing_mode=_DED_SHARING_MODES[0]):
        ...
        proc_cfg.has_dedicated_proc = True
        proc_cfg.sharing_mode = sharing_mode
        return proc_cfg
    ...
    @has_dedicated_proc.setter
    def has_dedicated_proc(self, val):
