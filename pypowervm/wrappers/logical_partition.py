...
class LPAR(bp.BasePartition, ewrap.WrapperSetUUIDMixin):
    ...
    def _can_modify(self, dlpar_cap):
    ...
    def can_modify_io(self):
        ...
        :return reason: A translated message that will indicate why it was not
                        ...
                        reason will be None.
        """
        return self._can_modify(self.capabilities.io_dlpar)
    ...
    def can_modify_mem(self):
        ...
        :return reason: A translated message that will indicate why it was not
                        ...
                        reason will be None.
        """
        return self._can_modify(self.capabilities.mem_dlpar)
    ...
    def can_modify_proc(self):
        ...
        :return reason: A translated message that will indicate why it was not
                        ...
                        reason will be None.
        """
        return self._can_modify(self.capabilities.proc_dlpar)
    ...
    def can_lpm(self):
        ...
        # TODO(IBM) Several additional checks are needed here...

        if self.rmc_state != bp.RMCState.ACTIVE:
            return False, _('LPAR does not have an active RMC connection.')

        c = self.capabilities
        if not (c.io_dlpar and c.mem_dlpar and c.proc_dlpar):
            return False, _('LPAR does not have a fully active DLPAR '
                            'connection.')
        return True, None
