...
class EntryWrapperGetter(object):
    ...
    pypowervm.utils.transaction.Transaction, or as the first parameter to a
...
class FeedGetter(EntryWrapperGetter):
    ...
    used to initialize a pypowervm.utils.transaction.FeedManager, allowing the
    FeedManager to defer the GET as long as possible, thus minimizing the
