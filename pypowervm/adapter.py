...
class Session(object):
    ...
    def __init__(self, host='localhost', username=None, password=None,
        ...
        # Number of seconds to sleep between connection retries
        delay = 2
        ...
        logon_request = retry.retry(
            tries=conn_tries, delay_func=delay_func,
    ...
    def _logon_request(self, headers, body, verify):
        """Issue the actual logon request to the REST server.

        :param headers: Dict of HTTP headers to send.
        :param body: Body of the logon request.
        :param verify: Whether to use SSL verification.
        :return: The result of the logon request.
        """
    ...
    def _logon(self, logon_request=None):
        if logon_request is None:
            logon_request = self._logon_request
