...
class ElementList(object):
    ...
    def __get_values(self):
        """List of the values within the entities.Element instances."""
    ...
    def __create_elem(self, val):
        ...
        :param val: The raw value for the text content of the new element.
                    E.g. self.__create_elem('foo') will yield an
                    entities.Element representing <tag ...>foo</tag> (where tag
                    is whatever this ElementList was initialized with).
        :return: A new entities.Element containing the specified val.
        """
