    ...
    def test_crt_cluster_ssp(self, mock_adp, mock_monitor_job, mock_del_job):
        ...
        def create_job(job_el, entry_type, *args, **kwargs):
            ...
            self.assertEqual(
                ...
                '://a.ibm.com:12443/rest/api/uom/VirtualIOServer/12345678-1234'
                '-1234-1234-123456789012" rel="related"/></uom:Node></uom:Node'
                '></uom:Cluster>')
            self.assertEqual(
                param_vals[1],
        ...
        mock_adp.create_job = create_job
        node = clust.Node()
        node.hostname = 'vios1'
        node.mtms = 'XXXX-YYY*ZZZZZZZ'
        node.lpar_id = 5
        node.vios_uri = ('https://a.ibm.com:12443/rest/api/uom/VirtualIOServer'
