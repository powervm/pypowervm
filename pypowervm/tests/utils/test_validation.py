...
class TestValidator(testtools.TestCase):
    ...
    def test_validator(self):
        # Test desired proc units > host avail proc units fails
        ...
        # Test desired proc units < host avail proc units passes
        vldn.LPARWrapperValidator(self.lpar_1_proc, self.mngd_sys)
