...
from pypowervm.utils.validation import MemValidator
from pypowervm.utils.validation import ProcValidator
...
class TestValidator(testtools.TestCase):
    ...
    def setUp(self):
        ...
        self.lpar_1_proc_ded_inactive = \
            _bld_lpar(has_dedicated=True, name='1_proc_ded_inactive',
                      state='shutdown')
    ...
    def test_validator(self):
        ...
        mem_vldr = MemValidator(self.lpar_6g_mem, self.mngd_sys,
        ...
        proc_vldr = ProcValidator(self.lpar_4_proc_ded, self.mngd_sys,
                                  cur_lpar_w=self.lpar_1_proc_ded)
        ...
        self.assertEqual(3, proc_vldr.delta_des_vcpus,
                         ...
                         ' in dedicated mode')
        proc_vldr = ProcValidator(self.lpar_2dot2_proc_units, self.mngd_sys,
        ...
        self.assertEqual(0.60, proc_vldr.delta_des_vcpus,
                         ...
                         ' shared mode')
        proc_vldr = ProcValidator(self.lpar_1dot6_proc_units, self.mngd_sys,
                                  cur_lpar_w=self.lpar_1_proc_ded)
        proc_vldr._populate_new_values()
        proc_vldr._populate_resize_diffs()
        self.assertEqual(0.60, proc_vldr.delta_des_vcpus,
