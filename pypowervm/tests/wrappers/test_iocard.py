...
class TestLogicalPort(twrap.TestWrapper):
    ...
    def test_logical_ports(self):
        ...
        lport._cfg_capacity('0.72%')
        self.assertEqual(0.72, lport.cfg_capacity)
...
class TestVLANList(unittest.TestCase):
    def test_unmarshal(self):
        ...
        self.assertEqual('ALL', card.VLANList.unmarshal('ALL'))
        self.assertEqual('NONE', card.VLANList.unmarshal('NONE'))

        # Test VLAN lists
        self.assertEqual([1, 2], card.VLANList.unmarshal('1 2'))
        self.assertEqual([0], card.VLANList.unmarshal('0'))
        self.assertEqual([5, 6, 2230, 3340],
                         card.VLANList.unmarshal('5 6 2230 3340'))

    def test_marshal(self):
        # Test ALL and NONE cases
        self.assertEqual('ALL', card.VLANList.marshal('ALL'))
        self.assertEqual('NONE', card.VLANList.marshal('NONE'))

        # Test VLAN lists
        self.assertEqual('1 2', card.VLANList.marshal([1, 2]))
        self.assertEqual('0', card.VLANList.marshal([0]))
        self.assertEqual('5 6 2230 3340',
                         card.VLANList.marshal([5, 6, 2230, 3340]))

        # Test error cases
        self.assertRaises(ValueError, card.VLANList.marshal, None)
        self.assertRaises(ValueError, card.VLANList.marshal, '')
        self.assertRaises(ValueError, card.VLANList.marshal, ' ')
