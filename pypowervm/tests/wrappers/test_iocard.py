...
class TestSRIOVAdapter(twrap.TestWrapper):
    ...
    def test_physical_ports(self):
        ...
        self.assertEqual(20, conv_port.cfg_max_ports)
        conv_port.cfg_max_ports = 40
        self.assertEqual(40, conv_port.cfg_max_ports)

        self.assertEqual(200, conv_port.min_granularity)

        self.assertEqual(20, conv_port.supp_max_ports)
        ...
        self.assertEqual(4, eth_port.cfg_max_ports)
        eth_port.cfg_max_ports = 40
        self.assertEqual(40, eth_port.cfg_max_ports)

        self.assertEqual(200, eth_port.min_granularity)

        self.assertEqual(4, eth_port.supp_max_ports)
