...
class TestMSEntryWrapper(unittest.TestCase):
    ...
    def test_get_capabilities(self):
        good_cap = {'active_lpar_mobility_capable': False,
        ...
        bad_cap = {'active_lpar_mobility_capable': True,
                   'inactive_lpar_mobility_capable': True,
                   'ibmi_lpar_mobility_capable': True,
                   'custom_mac_addr_capable': False,
                   'ibmi_restrictedio_capable': True,
                   'ibmi_nativeio_capable': True,
                   'simplified_remote_restart_capable': True,
                   'aix_capable': False,
                   'ibmi_capable': True,
                   'linux_capable': False,
                   ...
                   'disable_secure_boot_capable': True,
