...
class TestVolumeGroup(twrap.TestWrapper):
    ...
    def test_add_vdisk(self):
        ...
        disk = stor.VirtualDisk.load(element=disk_elem)
    ...
    def test_add_phys_vol(self):
        ...
        phys_vol = stor.PV.load(element=phys_v)
    ...
    def test_add_media_repo(self):
        ...
        vmedia_repo = stor.VirtualOpticalMedia.load(element=vmedia_r)
    ...
    def test_update_media_repo(self):
        ...
        new_media = stor.VirtualOpticalMedia.load(element=new_m)
