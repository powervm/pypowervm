...
class TestEnterprisePoolFile(test_wrapper_abc.TestWrapper):
    ...
    def test_available_mobile_proc_units(self):
        self.assertEqual(16, self.dwrap.available_mobile_proc_units)
    ...
    def test_management_consoles(self):
        self.assertEqual(entry_wrapper.WrapperElemList,
                         type(self.dwrap.management_consoles))
        self.assertEqual(1, len(self.dwrap.management_consoles))
        console = self.dwrap.management_consoles[0]
        self.assertEqual(ep.EnterprisePoolManagementConsole, type(console))
        ...
        self.assertEqual('9.1.2.3', console.ip_address)
...
class TestEnterprisePoolMemberFile(test_wrapper_abc.TestWrapper):
    ...
    def test_mobile_proc_units(self):
        self.assertEqual(4, self.dwrap.mobile_proc_units)
    ...
    def test_inactive_proc_units(self):
        self.assertEqual(2, self.dwrap.inactive_proc_units)
    ...
    def test_system_name(self):
        self.assertEqual('Server-8284-22A-SN21B63CV', self.dwrap.system_name)

    def test_system_installed_proc_units(self):
        self.assertEqual(20, self.dwrap.system_installed_proc_units)

    def test_system_installed_memory(self):
        self.assertEqual(524288, self.dwrap.system_installed_memory)

    def test_system_mtms(self):
        self.assertEqual('8284-22A*21B63CV', self.dwrap.system_mtms)

    def test_system_state(self):
        self.assertEqual('operating', self.dwrap.system_state)
