...
class TestNetwork(twrap.TestWrapper):
    ...
    def test_part_id_by_loc_code(self):
        ...
        fail_loc = 'abc1234'
        self.assertEqual(net.part_id_by_loc_code(test_loc), '2')
        self.assertIsNone(net.part_id_by_loc_code(fail_loc))
    ...
    def test_load_groups(self):
        ...
        self.assertEqual('4', prim_ld_grp.trunk_adapters[0].part_id)
