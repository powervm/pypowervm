...
class TestCNAWrapper(twrap.TestWrapper):
    ...
    def test_attrs(self):
        ...
        self.assertEqual(0, self.entries.vswitchid)
    ...
    def test_vswitchid(self):
        self.assertEqual(0, self.entries.vswitchid)

    def test_vsi_type_id(self):
        self.assertEqual('VSITID', self.entries.vsi_type_id)

    def test_vsi_type_version(self):
        self.assertEqual('77.99', self.entries.vsi_type_version)

    def test_vsi_type_manager_id(self):
        self.assertEqual('VSIMID', self.entries.vsi_type_manager_id)
