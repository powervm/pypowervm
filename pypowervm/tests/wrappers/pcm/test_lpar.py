...
class TestLparLTM(testtools.TestCase):
    ...
    def test_parse(self):
        ...
        self.assertEqual(4, len(info.lpars_util))
        ...
        # Assert that we had entries in JSON for VMs which were in error
        ...
        # And assert that these errored VMs are not part of parsed
        # LparInfo object
        self.assertNotIn("3B0237F9-26F1-41C7-BE57-A08C9452AD9D",
                         info.to_dict())
        self.assertNotIn("vm_inactive_rmc", info.to_dict())
