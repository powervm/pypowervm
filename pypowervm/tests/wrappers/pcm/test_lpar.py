...
class TestLparLTM(testtools.TestCase):
    ...
    def test_parse(self):
        ...
        self.assertEqual(1024, lpar.memory.total_pg_sp_size_count)
        self.assertEqual(512, lpar.memory.total_pg_sp_free_count)
        self.assertEqual(64, lpar.memory.vm_active_pg_count)
        ...
        self.assertEqual(4096, lpar.memory.total_pg_sp_size_count)
        self.assertEqual(2048, lpar.memory.total_pg_sp_free_count)
        self.assertEqual(256, lpar.memory.vm_active_pg_count)
        self.assertEqual(1048576, lpar.memory.real_mem_size_bytes)
        ...
        self.assertIsNone(lpar.memory.total_pg_sp_size_count)
        self.assertIsNone(lpar.memory.total_pg_sp_free_count)
        self.assertIsNone(lpar.memory.vm_active_pg_count)
