...
class TestPhypLTM(testtools.TestCase):
    ...
    def test_parse(self):
        ...
        sample = info.sample
        self.assertEqual(806297258933149, sample.time_based_cycles)
        ...
        self.assertEqual([], bad_lpar.veas)
        self.assertEqual([], bad_lpar.storage_adpts)
        ...
        self.assertEqual(4, good_lpar.processor.max_virt_procs)
        self.assertEqual(.4, good_lpar.processor.max_proc_units)
        ...
        self.assertEqual(0, vea.received_packets)
        self.assertEqual(0, vea.sent_packets)
        self.assertEqual(0, vea.dropped_packets)
        self.assertEqual(0, vea.sent_bytes)
        self.assertEqual(0, vea.received_bytes)
        ...
        # VM storage
        stor = good_lpar.storage_adpts[0]
