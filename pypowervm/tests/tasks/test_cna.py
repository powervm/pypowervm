...
class TestVNET(twrap.TestWrapper):
    ...
    def test_get_partitions(self, mock_vio_get, mock_lpar_get, mock_mgmt_get):
        ...
        # Basic case
        self.assertEqual(vioses + lpars, cna._get_partitions(adpt))

        # Different permutations
        self.assertEqual(lpars + [mgmt], cna._get_partitions(
            adpt, get_vioses=False, get_mgmt=True))
        self.assertEqual(vioses, cna._get_partitions(
            adpt, get_lpars=False, get_mgmt=True))
        ...
        # Different permutations
        self.assertEqual(lpars, cna._get_partitions(
            adpt, get_vioses=False, get_mgmt=True))
        self.assertEqual(vioses + [mgmt], cna._get_partitions(
            adpt, get_lpars=False, get_mgmt=True))
