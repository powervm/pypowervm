...
class TestVOpt(testtools.TestCase):
    ...
    @mock.patch('pypowervm.tasks.vopt._get_vioses')
    ...
    def test_validate_vopt_vg2(self, mock_vg_get, mock_vios_get):
        ...
        # Run
        vio_ret_uuid, vg_ret_uuid = vopt.validate_vopt_repo_exists(self.apt)
        self.assertEqual('vio_id', vio_ret_uuid)
        self.assertEqual('vg_uuid', vg_ret_uuid)

        # Validate
        self.assertEqual('vg_uuid', vopt._cur_vg_uuid)
        self.assertEqual('vio_id', vopt._cur_vios_uuid)
