...
class TestMisc(twrap.TestWrapper):
    ...
    def test_find_pport(self):
        self.assertEqual((None, None), tsriov.find_pport('bogus', self.dwrap))
        sriov, pport = tsriov.find_pport('U78C7.001.RCH0004-P1-C8-T2',
                                         self.dwrap)
        self.assertEqual('U78C7.001.RCH0004-P1-C8', sriov.phys_loc_code)
        self.assertEqual(1, sriov.sriov_adap_id)
