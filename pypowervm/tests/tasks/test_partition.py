...
class TestVios(twrap.TestWrapper):
    ...
    def test_get_partitions(self, mock_vio_get, mock_lpar_get, mock_mgmt_get):
        ...
        # Basic case
        self.assertEqual(vioses + lpars, tpar.get(adpt))

        # Different permutations
        self.assertEqual(lpars + [mgmt], tpar.get(
            adpt, vioses=False, mgmt=True))
        self.assertEqual(vioses, tpar.get(
        ...
        # Different permutations
        self.assertEqual(lpars, tpar.get(
            adpt, vioses=False, mgmt=True))
        self.assertEqual(vioses + [mgmt], tpar.get(
            adpt, lpars=False, mgmt=True))
