...
class TestVios(twrap.TestWrapper):
    ...
    def setUp(self):
        ...
        boot_p = mock.patch('psutil.get_boot_time')
        self.mock_boot_time = boot_p.start()
        self.addCleanup(boot_p.stop)
        self.mock_boot_time.return_value = 3600
    ...
    def test_validate_vios_ready_default_after_boot(self, mock_get, mock_wait):
        ...
        self.mock_boot_time.return_value = time.time() - 900
