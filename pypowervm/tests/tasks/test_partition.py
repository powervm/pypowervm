...
class TestPartition(testtools.TestCase):
    ...
    def test_get_mgmt_vio(self):
        ...
        mgmt_w = tpar.get_mgmt_partition(self.adpt)
        self.assertTrue(mgmt_w.is_mgmt_partition)
        self.assertEqual('7DBBE705-E4C4-4458-8223-3EBE07015CA9',
                         mgmt_w.uuid)
    ...
    def test_get_me(self, mock_my_id, mock_search):
        ...
        # Good path - one hit
        mock_search.return_value = [lpar.LPAR.wrap(self.mgmt_lpar)[0]]
        ...
        mock_search.return_value = lpar.LPAR.wrap(self.mgmt_lpar)
