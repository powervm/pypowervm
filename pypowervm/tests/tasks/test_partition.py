...
class TestVios(twrap.TestWrapper):
    ...
    def test_get_partitions(self, mock_vio_get, mock_lpar_get, mock_mgmt_get):
        ...
        # Basic case
        self.assertEqual(vioses + lpars, tpar.get_lpars(adpt))

        # Different permutations
        self.assertEqual(lpars + [mgmt], tpar.get_lpars(
            adpt, get_vioses=False, get_mgmt=True))
        self.assertEqual(vioses, tpar.get_lpars(
        ...
        # Different permutations
        self.assertEqual(lpars, tpar.get_lpars(
            adpt, get_vioses=False, get_mgmt=True))
        self.assertEqual(vioses + [mgmt], tpar.get_lpars(
            adpt, get_lpars=False, get_mgmt=True))
