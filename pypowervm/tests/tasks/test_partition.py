...
class TestVios(twrap.TestWrapper):
    ...
    def setUp(self):
        ...
        uptime_p = mock.patch('pypowervm.util.get_uptime')
        self.mock_uptime = uptime_p.start()
        self.addCleanup(uptime_p.stop)
        self.mock_uptime.return_value = 3601
    ...
    def test_validate_vios_ready_default_after_boot(self, mock_get, mock_wait):
        ...
        self.mock_uptime.return_value = 900
