...
class TestIscsi(testtools.TestCase):
    ...
    def test_add_parameter(self, mock_job_w):
        ...
        parm_array = []
        final_array = [("bool", "True"), ("int", "0"), ("int list", "[0,1]"),
                       ("str", "str"), ("str list", "[str1,str2]")]
        iscsi._add_parameter(parm_array, mock_job_w, "None", None)
        iscsi._add_parameter(parm_array, mock_job_w, "bool", True)
        iscsi._add_parameter(parm_array, mock_job_w, "int", 0)
        iscsi._add_parameter(parm_array, mock_job_w, "int list", [0, 1])
        iscsi._add_parameter(parm_array, mock_job_w, "str", "str")
        iscsi._add_parameter(parm_array, mock_job_w, "str list",
                             ["str1", u'str2'])
