...
class TestHostCPUStats(testtools.TestCase):
    ...
    def setUp(self):
        ...
        self.get_cpu_freq_p = mock.patch(
            'pypowervm.tasks.monitor.host_cpu.HostCPUStats._get_cpu_freq')
        self.mock_get_cpu_freq = self.get_cpu_freq_p.start()
    ...
    def test_get_cpu_freq(self, mock_cmd):
        # Need to stop the patcher to test this
        self.get_cpu_freq_p.stop()
        host_stats = host_cpu.HostCPUStats(self.adpt, 'host_uuid')
