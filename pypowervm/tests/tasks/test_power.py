...
class TestPower(testtools.TestCase):
    ...
    def test_pwrop_stop(self):
        ...
        self.assertRaises(
            ...
            oper=power.PowerOp.OP_PWROFF_OS_IMMED,
            add_parms={'one': 1, 'foo': 'bar', 'restart': 'true'}, timeout=100,
            synchronous=False)
        self.assertEqual(1, self.run_job.call_count)
        ...
        self.assertRaises(
            ...
            oper=power.PowerOp.OP_PWROFF_VSP_NORM, add_parms={'foo': 'bar'})
        self.assertEqual(1, self.run_job.call_count)
    ...
    def test_pwrop_stop_no_rmc(self):
        ...
        self.assertRaises(pexc.OSShutdownNoRMC, power.PowerOp.stop,
                          part, oper=power.PowerOp.OP_PWROFF_OS_NORM)
