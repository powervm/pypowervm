    ...
    def test_register_vfc_mapping(self):
        ...
        for vio in (vio1, vio2):
            for vfcmap in vio.vfc_mappings:
                ...
                i += 1
        self.assertEqual(
            {3: {'VFC': {'fab1_wwpn': ['C05076065A8B005A', 'C05076065A8B005B'],
                         'fab10_wwpn': None,
                         'fab11_wwpn': None,
                         'fab12_wwpn': ['C05076065A7C02D6', 'C05076065A7C02D7'],
                         'fab13_wwpn': ['C05076065A7C030E', 'C05076065A7C030F'],
                         'fab14_wwpn': None,
                         'fab15_wwpn': ['C05076065A7C02D4', 'C05076065A7C02D5'],
                         'fab16_wwpn': None,
                         'fab17_wwpn': ['C05076065A7C02E0', 'C05076065A7C02E1'],
                         'fab18_wwpn': ['C05076065A7C02E0', 'C05076065A7C02E1'],
                         'fab19_wwpn': ['C05076065A7C02E0', 'C05076065A7C02E1'],
                         'fab20_wwpn': None,
                         'fab21_wwpn': None,
                         'fab22_wwpn': None,
                         'fab23_wwpn': None,
                         'fab24_wwpn': None,
                         'fab25_wwpn': ['C05076065A7C0002', 'C05076065A7C0003'],
                         'fab26_wwpn': ['C05076065A7C030A', 'C05076065A7C030B'],
                         'fab28_wwpn': None,
                         'fab29_wwpn': None,
                         'fab3_wwpn': None,
                         'fab30_wwpn': ['C05076065A7C030C', 'C05076065A7C030D'],
                         'fab31_wwpn': None,
                         'fab32_wwpn': None,
                         'fab33_wwpn': None,
                         'fab4_wwpn': None,
                         'fab5_wwpn': ['C05076065A7C02E4', 'C05076065A7C02E5'],
                         'fab6_wwpn': None,
                         'fab7_wwpn': None,
                         'fab8_wwpn': ['C05076065A7C02E2', 'C05076065A7C02E3'],
                         'fab9_wwpn': None,
                         'fab1': None, 'fab10': None,
                         ...
                         'fab7': None, 'fab8': None,
                         'fab9': None}},
             6: {'VFC': {'fab2_wwpn': ['C05076065A8B0060', 'C05076065A8B0061'],
                         'fab2': None}},
             8: {'VFC': {'fab27_wwpn': ['C05076065A7C0000', 'C05076065A7C0001'],
                         'fab27': None}}},
            smt.topology)
