...
class TestHDisk(unittest.TestCase):
    ...
    def test_create_lua_inv_xml(self):
        ...
        exp_xml = ('<uom:VIO xmlns:uom="http://www.ibm.com/xmlns/systems/'
                   ...
                   '"http://ausgsa.austin.ibm.com/projects/v/vios/schema/1.21"'
        ...
        self.assertEqual(exp_xml, hdisk._lua_inventory_xml(None, udid))

    def test_process_lua_inv(self):
