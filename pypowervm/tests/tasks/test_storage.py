...
class TestUploadLV(testtools.TestCase):
    ...
    @mock.patch('pypowervm.tasks.storage._create_file')
    def test_upload_new_vopt_w_retry(self, mock_create_file, mock_sleep):
        ...
        # Validate that there was a sleep invocation and multiple executions
        # of the upload
    ...
    @mock.patch('time.sleep')
    @mock.patch('pypowervm.tasks.storage._create_file')
    def test_upload_new_vopt_w_fail(self, mock_create_file, mock_sleep):
        ...
        # Three loops (so three sleeps) before the failure bubbles up
