...
class TestUploadLV(testtools.TestCase):
    ...
    @mock.patch('pypowervm.util.eintr_retry')
    ...
    @mock.patch('pypowervm.tasks.storage._create_file')
    def test_upload_stream_local_func(self, mock_epc, mock_create_file):
    ...
    def test_ensure_pipe_close(self, mock_open, mock_os):
        ...
        self.assertEqual(1, mock_open.return_value.__enter__.call_count)
